...
export default function ExpenseModal() {
  ...
  return (
    <>
      <div className="fixed right-5 bottom-5 flex items-center justify-center dark:bg-slate-900">
        <button
          type="button"
          onClick={() => dispatch({type:'show-modal'})}
        >
          <PlusCircleIcon className='w-16 h-16 text-blue-600 rounded-full dark:text-blue-500' />
        </button>
      </div>
